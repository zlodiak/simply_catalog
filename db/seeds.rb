...
Product.create!(:title => 'телевизоры', :is_catalog: true).move_to_child_of(video)
Product.create!(:title => 'стойки и кронштейны', :is_catalog: true).move_to_child_of(video)
Product.create!(:title => 'аксессуары', :is_catalog: true).move_to_child_of(video)
